...
### NOTES: ###
# This is copied from djangorestframework-bulk pip library and modified for our needs.
# You may use this as reference to update our own fork branch, to keep it up to date.
#
# Original git:
#       https://github.com/miki725/django-rest-framework-bulk
# Purple git:
#       https://github.com/purple-desk/django-rest-framework-bulk
#       (in requirements.txt use: git+git://github.com/purple-desk/django-rest-framework-bulk.git)
##############
...
##################
# These APIViews are copied from the original lib, to make this util module stand-alone:
...
class BulkUpdateAPIView(BulkUpdateModelMixin,
                        GenericAPIView):
...
class BulkDestroyAPIView(BulkDestroyModelMixin,
                         GenericAPIView):
